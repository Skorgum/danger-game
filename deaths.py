...
DEATH_MESSAGES = [
    ...
    "You step through the door and it slams behind you. The room gets suddenly really cold! You desperately try in vain to open the sealed door before passing out from hypothermia. Game over small brain!",    
]
